...
func (in *SealedSecretSpec) DeepCopyInto(out *SealedSecretSpec) {
	*out = *in
	...
	if in.Rotation != nil {
		...
		*out = new(SealedSecretRotationPolicySpec)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SealedSecretRotationPolicySpec) DeepCopyInto(out *SealedSecretRotationPolicySpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SealedSecretRotationPolicySpec.
func (in *SealedSecretRotationPolicySpec) DeepCopy() *SealedSecretRotationPolicySpec {
	if in == nil {
		return nil
	}
	out := new(SealedSecretRotationPolicySpec)
